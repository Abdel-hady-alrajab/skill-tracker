        ...
        >
            <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8 w-full max-w-md relative">
                ...
                <div className="flex gap-3 justify-end mt-7">
                    <button
                        onClick={onClose}
                        className="text-sm font-semibold px-5 py-2.5 rounded-lg border border-slate-700 text-slate-400 hover:text-white hover:border-slate-500 transition-all"
                    >
                        Cancel
                    </button>
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="text-sm font-bold px-6 py-2.5 rounded-lg bg-blue-500 hover:bg-blue-400 disabled:opacity-50 disabled:cursor-not-allowed text-white transition-all"
                    >
